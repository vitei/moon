...
void generator::c::OutputVariables::run(generator::c::Printer *printer, tree::Program *program)
{
	generator::c::OutputVariables operation;
	operation.mPrinter = printer;
	program->accept(&operation);
}

void generator::c::OutputVariables::visit(tree::Program *program)
{
...
void generator::c::OutputVariables::visit(tree::Aggregate *aggregate)
{
...
void generator::c::OutputVariables::visit(tree::Use *use)
{
...
void generator::c::OutputVariables::visitScope(tree::Scope *scope)
{
