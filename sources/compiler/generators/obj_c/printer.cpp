...
#include "compiler/generators/obj_c/printer.h"
#include "compiler/generators/obj_c/mangled.h"

void generator::objC::Printer::dispatch(tree::Node *node)
{
	GENERATE_DISPATCH(node, output)
}

void generator::objC::Printer::output(tree::Scope *scope)
{
	increaseDepth();
...
void generator::objC::Printer::output(tree::Function *function)
{
...
void generator::objC::Printer::output(tree::AnonymousScope *anonymousScope)
{
	increaseDepth();
...
void generator::objC::Printer::output(tree::Import *import)
{
...
void generator::objC::Printer::output(tree::FunctionPrototype *functionPrototype)
{
	outputTabs();
	outputDeclaration(functionPrototype, true);
...
void generator::objC::Printer::output(tree::Identity *identity)
{
	ASSERT(identity->getMetadata());
	generator::objC::Mangled *cName = static_cast<generator::objC::Mangled *>(identity->getMetadata());

	*mOutput << cName->useName;
}

void generator::objC::Printer::output(tree::Cast *cast)
{
...
void generator::objC::Printer::output(tree::IfExpression *ifExpression)
{
...
void generator::objC::Printer::output(tree::DirectAccess *directAccess)
{
	...
	if(functionCall)
	{
		...
		generator::objC::Mangled *cName = static_cast<generator::objC::Mangled *>(prototype->getMetadata());
...
void generator::objC::Printer::output(tree::MessageAccess *messageAccess)
{
	ERROR("FIXME");
}

void generator::objC::Printer::output(tree::ArrayAccess *arrayAccess)
{
...
void generator::objC::Printer::output(tree::FunctionCall *functionCall)
{
	tree::FunctionPrototype *prototype = static_cast<tree::FunctionPrototype *>(functionCall->getPrototype());
...
void generator::objC::Printer::output(tree::BoolLiteral *boolLiteral)
{
	*mOutput << (boolLiteral->getValue() ? "true" : "false");
}

void generator::objC::Printer::output(tree::IntLiteral *intLiteral)
{
	*mOutput << intLiteral->getValue();
}

void generator::objC::Printer::output(tree::FloatLiteral *floatLiteral)
{
	*mOutput << floatLiteral->getValue();
}

void generator::objC::Printer::output(tree::StringLiteral *stringLiteral)
{
	*mOutput << "\"";
...
void generator::objC::Printer::output(tree::Assign *assign)
{
...
void generator::objC::Printer::output(tree::LogicalOr *logicalOr)
{
	*mOutput << "(";
...
void generator::objC::Printer::output(tree::LogicalAnd *logicalAnd)
{
	*mOutput << "(";
...
void generator::objC::Printer::output(tree::Or *orExpression)
{
	*mOutput << "(";
...
void generator::objC::Printer::output(tree::Xor *xorExpression)
{
	*mOutput << "(";
...
void generator::objC::Printer::output(tree::And *andExpression)
{
	*mOutput << "(";
...
void generator::objC::Printer::output(tree::Equal *equal)
{
	*mOutput << "(";
...
void generator::objC::Printer::output(tree::Unequal *unequal)
{
	*mOutput << "(";
...
void generator::objC::Printer::output(tree::LessThan *lessThan)
{
	*mOutput << "(";
...
void generator::objC::Printer::output(tree::LessEqual *lessEqual)
{
	*mOutput << "(";
...
void generator::objC::Printer::output(tree::GreaterThan *greaterThan)
{
	*mOutput << "(";
...
void generator::objC::Printer::output(tree::GreaterEqual *greaterEqual)
{
	*mOutput << "(";
...
void generator::objC::Printer::output(tree::Add *add)
{
	*mOutput << "(";
	dispatch(add->getLHS());
	*mOutput << ") + (";
...
void generator::objC::Printer::output(tree::Subtract *subtract)
{
	*mOutput << "(";
...
void generator::objC::Printer::output(tree::Multiply *multiply)
{
	*mOutput << "(";
...
void generator::objC::Printer::output(tree::Divide *divide)
{
	*mOutput << "(";
...
void generator::objC::Printer::output(tree::Modulus *modulus)
{
	*mOutput << "(";
...
void generator::objC::Printer::output(tree::LogicalNot *logicalNot)
{
	*mOutput << "!(";
...
void generator::objC::Printer::output(tree::Not *notExpression)
{
	*mOutput << "~(";
...
void generator::objC::Printer::output(tree::Minus *minus)
{
	*mOutput << "-(";
...
void generator::objC::Printer::output(tree::UDT *udt)
{
	ASSERT(udt->getMetadata());
	generator::objC::Mangled *cName = static_cast<generator::objC::Mangled *>(udt->getMetadata());
...
void generator::objC::Printer::output(tree::This *th1s)
{
	*mOutput << "moon$$this";
}

void generator::objC::Printer::output(tree::Break *breakStatement)
{
	outputTabs();
...
void generator::objC::Printer::output(tree::Execute *execute)
{
	outputTabs();
...
void generator::objC::Printer::output(tree::If *ifStatement)
{
	outputTabs();
	*mOutput << "if(";
...
void generator::objC::Printer::output(tree::For *forStatement)
{
...
void generator::objC::Printer::output(tree::While *whileStatement)
{
	outputTabs();
	*mOutput << "while(";
...
void generator::objC::Printer::output(tree::Return *returnStatement)
{
	outputTabs();
...
void generator::objC::Printer::outputEOS()
{
	*mOutput << ";" << std::endl;
}

void generator::objC::Printer::outputExtern(tree::TypedIdentity *typedIdentity)
{
	*mOutput << "extern ";
	outputDeclaration(typedIdentity);
	outputEOS();
...
void generator::objC::Printer::outputDeclaration(tree::TypedIdentity *typedIdentity, bool functionPrototype)
{
	tree::Type *type = typedIdentity->getType();

	ASSERT(typedIdentity->getMetadata());
	generator::objC::Mangled *cName = static_cast<generator::objC::Mangled *>(typedIdentity->getMetadata());
...
void generator::objC::Printer::outputType(tree::Type *type)
{
	tree::Int *integer;
...
void generator::objC::Printer::outputDimensions(tree::Type *type)
{
	tree::String *string;
	tree::Array *array;
...
void generator::objC::Printer::outputVariablesBegin()
{
	outputTabs();
...
void generator::objC::Printer::outputVariablesEnd()
{
	decreaseDepth();
...
void generator::objC::Printer::outputNewBegin()
{
	outputTabs();
...
void generator::objC::Printer::outputNewEnd()
{
	outputTabs();
...
void generator::objC::Printer::outputBootstrapMain()
{
	outputTabs();
...
void generator::objC::Printer::outputPragma(std::string pragma)
{
	*mOutput << pragma << std::endl;
}

void generator::objC::Printer::outputRaw(std::string data)
{
	*mOutput << data;
}

void generator::objC::Printer::outputTabs()
{
